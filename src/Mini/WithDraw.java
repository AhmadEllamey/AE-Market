...
import static Mini.Main.WithDrawFrameWindow;
    ...
    public WithDraw() {
        ...
        OKButton.addActionListener(e -> {
            try{
                ...
                String CashUpdate = "Insert Into cash (user_name,type, amount , note) VALUES ('"+userName+"','Withdraw' ,"+(Double.parseDouble(cashText.getText().trim())*-1)+",'"+noteWhatHappened.getText().trim()+"')";
